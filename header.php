            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    ...
                    <ul>
                        ...
                        <li <?php if (is_page('blog') or wp_get_post_parent_id(0) == 13) echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/about-us') ?>"><a href="<?php echo site_url('/blog') ?>">Blog</a></li>
                    </ul>
